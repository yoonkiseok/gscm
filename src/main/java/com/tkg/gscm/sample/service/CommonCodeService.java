...
public class CommonCodeService {
	...
	public List<Map<String, Object>> selectCommonGroupCodeList(Map<String, Object> paramMap) throws Exception {
//		return commonDao.selectCommonGroupCodeList(paramMap);
	...
	public List<Map<String, Object>> selectCommonCodeList(Map<String, Object> paramMap) throws Exception {
